...
**Status:** Backend COMPLETE (AD-024, AD-026, AD-027)
...
3. For each distinct `productCode`, update live `Component` `catalogueMetrics.hwCost` / `hwRetail`, Super White `retailPrice`, and **all VARIANT finish prices** (same HW Retail term as Excel)
